...
export const faqs = [
  ...
  {
    header: 'How to use Cloud Storage?',
...
export const ONBOARDING_DATA = [
  {
    title: 'Turn on Cloud Storage',
    svg: 1,
    description:
      'To turn your Uup-Cloud device, plug on end of a Type-C Cable into your Uup-Cloud device, and the other end plug into the power adapter into a wall outlet.',
  },
  {
    title: 'Connect to the Internet',
    svg: 2,
    description:
      'Plug one end of an Ethernet cable into the Ethernet port on your WiFi router, the another end plug  into the Ethernet port of Uup-Cloud',
  },
  {
    title: 'Connect app with the device',
    svg: 3,
    description:
      'Find the instruction document in the package box. To connect app to Uup-Cloud box, you need to do the following steps: \n \n 1. Scan QR Code \n \n 2. Then enter 6-digit secure code',
  },
  {
    title: 'Manage your files',
    description:
      'Save your files and media to Uup-Cloud and access them from any device, anywhere.',
    svg: 4,
  },
];
