...
class ShareViewController: SLComposeServiceViewController {
 ...
 let shareProtocol = "cloudstorageShareProtocol" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
